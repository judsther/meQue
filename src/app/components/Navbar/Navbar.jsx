  ...
  return (
    <div className="flex justify-center">
      <nav className="absolute m-5  flex w-auto items-center justify-center z-50">
        <div className=" flex gap-10 items-center border-2 border-[#F1B000] bg-black/60 md:bg-black/20 backdrop-blur-xs rounded-xs px-2 md:px-16 py-3 md:py-1 ">
          <Link className="hidden sm:block md:me-6" href={"/"}>
            <CldImage
